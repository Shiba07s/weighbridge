  ...
  const fetchTransactions = async () => {
    try {
      const response = await axios.get(
        "http://localhost:7070/api/v1/gate-user/transaction"
      );
              ...
              <tr key={transaction.transactionId}>
                ...
                <td>
                  <button
                    ...
                    onClick={() =>
                      updateTransactions(transaction.transactionId)
                    }
                  >
                    Click Here
                  </button>
...
export default ListWeighBridgeOperator;
